import { c as create_ssr_component, i as add_attribute, v as validate_component } from "./index.js";
...
const Loading = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="h-full w-full flex flex-col items-center justify-center"><div class="flex items-center justify-center w-full">${validate_component(Spinner, "Spinner").$$render($$result, {}, {}, {})}</div></div>`;
});
export {
  Loading as L
};
